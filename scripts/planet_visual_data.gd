...
## Cloud layer lower altitude (multiplier of planet radius).
@export_range(1.001, 1.1) var cloud_lower: float = 1.003

## Cloud layer upper altitude (multiplier of planet radius).
@export_range(1.005, 1.2) var cloud_upper: float = 1.02
